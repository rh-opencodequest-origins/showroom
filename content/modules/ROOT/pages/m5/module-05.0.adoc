...
![the architecture](image:m5/architecture.png[] )
...
URL Gitops pour OCQ - rhdh-gitops/
URL Gitlab - dev{team-id}
Namespace backstage à changer rhdh-dev{team-id}
