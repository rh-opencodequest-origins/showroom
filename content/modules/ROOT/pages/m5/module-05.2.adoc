...
* On {product_name_rhdh}, in the `parasol-store` component's https://backstage-rhdh-{team-id}.{openshift_cluster_ingress_domain}/catalog/default/component/parasol-store/pr[Pull/Merge Requests page, window="rhdh"], you can view the a list of Gitlab Merge Request Statuses.
