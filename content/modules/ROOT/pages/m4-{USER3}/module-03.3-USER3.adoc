...
<div class="pe">
++++
The Software Template you'll be using in this activity is stored in the _template.yaml_ file in the https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/quarkus-with-spring-postgresqle[rhdh/quarkus-with-spring-postgresql, window="gitlab"] repository in GitLab.
