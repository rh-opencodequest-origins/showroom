...
Your lab environment's {product_name_rhdh} has the Argo CD plugin enabled and preconfigured, as can be seen in the https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/developer-hub-config/-/blob/main/values.yaml[valyes.yaml in the rhdh/developer-hub-config^, window="gitlab"].
