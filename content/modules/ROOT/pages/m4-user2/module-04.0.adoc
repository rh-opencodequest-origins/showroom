...
The Software Template you'll be using in this activity is stored in the https://gitlab-gitlab.{openshift_cluster_ingress_domain}/rh-opencodequest-origins/opencodequest-templates/tree/main/scaffolder-templates/quarkus-with-spring-postgresql[template.yaml, window="gitlab"] file in the repository in GitLab.
