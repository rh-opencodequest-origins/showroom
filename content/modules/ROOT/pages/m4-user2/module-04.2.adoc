...
IMPORTANT: Please make sure you are logged in as a Platform Engineer with *`{pe-username}` / `{common_password}`* as you were guided to in the previous step. We advise you to use a *private/incognito window* to log out properly!  
...
Now that the form has been fixed, it should be easy-peasy!  
...
Where are the steps to create a repository in GitLab? 
Where are the steps to create our ArgoCD resources for our project?
