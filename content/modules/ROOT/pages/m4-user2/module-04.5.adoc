...
```bash
wget https://github.com/rh-opencodequest-origins/fullcodebase/raw/refs/heads/main/villain-service.zip -O villain-service.zip && unzip villain-service.zip && rm villain-service.zip
```
