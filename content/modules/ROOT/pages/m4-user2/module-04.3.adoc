...
. Open this file describing the template :   https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/quarkus-with-spring-postgresql/-/blob/main/template.yaml[template.yaml, window="gitlab"].
