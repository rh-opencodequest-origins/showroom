...
As the platform engineering is the entry point for project developments, getting the right overview of objects created and integrations performed is paramount!
