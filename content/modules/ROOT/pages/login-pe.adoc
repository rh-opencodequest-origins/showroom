...
+
image::common/rhdh-sign-out-dev.png[Signing out of {product_name_rhdh} from Profile dropdown,link=self,window=blank]
...
+
image::common/gitlab-sign-out-dev.png[Signing out of GitLab from Profile dropdown,link=self,window=blank]
