...
Check the content here : -> https://gitlab-gitlab.{openshift_cluster_ingress_domain}/rhdh/quarkus-with-spring-postgresql/-/blob/main/template.yaml[template.yaml, window="gitlab"].
