...
The *System* is a collection of entities that cooperate to perform some function. For instance, in 3 3-tier application, the 3 components belong to the same system. It eases their management.
