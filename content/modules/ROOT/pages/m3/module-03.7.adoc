...
. There are *2 sections* in the {product_name_rhdh} configuration that need to be modified. All of them are under `-- RBAC --` blocks. You can use `CMD + /` or `CTRL + /` keys to uncomment the blocks.
