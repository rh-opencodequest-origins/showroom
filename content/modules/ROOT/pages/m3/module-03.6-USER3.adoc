...
Check the content here : -> https://gitlab-gitlab.{openshift_cluster_ingress_domain}/peteam{team-id}/quarkus-ai/-/blob/main/template.yaml[template.yaml, window="gitlab"].
...
. Step *3* - Choose the template  *OpenCodeQuest - AI-Infused application with Quarkus* to refresh
