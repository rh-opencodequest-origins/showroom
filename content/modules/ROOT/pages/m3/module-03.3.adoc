...
Your mission to onboard the OpenCode Quest project.
...
* a skeleton for the source code repository
* a source code repository
* a IDE Cloud
* a CI/CD pipeline
* a container image registry repository
...
*User 1 -> Quarkus + postgreSQL template   xref:m4-user1/module-04.0.adoc[link]*

*User 2 -> Quarkus Spring compatible + postgreSQL the  xref:m4-user2/module-04.0.adoc[link]*

*User 3 -> Quarkus with AI capabilities  xref:m4-user3/module-04.0.adoc[link]* 
