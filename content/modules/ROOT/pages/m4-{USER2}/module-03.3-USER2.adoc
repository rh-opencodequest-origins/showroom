...
<div class="pe">
++++
The Software Template you'll be using in this activity is stored in the _template.yaml_ file in the https://gitlab-gitlab.{openshift_cluster_ingress_domain}/peteam{team-id}/quarkus-ai[rhdh/quarkus-with-spring-postgresql, window="gitlab"] repository in GitLab.
https://github.com/rh-opencodequest-origins/opencodequest-templates/tree/main/scaffolder-templates/quarkus-ai
...
----
https://gitlab-gitlab.{openshift_cluster_ingress_domain}/peteam{team-id}/opencodequest-templates/-/blob/main/scaffolder-templates/quarkus-ai/template.yaml?ref_type=heads
----
