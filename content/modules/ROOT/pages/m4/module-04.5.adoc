...
. Visit your instance of https://backstage-backstage.{openshift_cluster_ingress_domain}[{product_name_rhdh}^, window="rhdh"]. If prompted, login as `{dev-username}` / `{common_password}`.
