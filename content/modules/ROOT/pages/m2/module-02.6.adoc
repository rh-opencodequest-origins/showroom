...
+
image:m2/gitlab-catalog-provider.png[GitLab Catalog Provider configuration,width=70%,link=self,window=blank]
...
+
image:m2/rhdh-logs-gitlab-discovery.png[GitLab Autodiscovery Logs in the OpenShift Console,link=self,window=blank]
