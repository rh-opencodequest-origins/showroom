...
image::m2/openshift-backstage.png[{product_name_rhdh} deployment on OpenShift]


= Quiz !

Be prepared to answer to our questions based on what you have learnt in this section! 
