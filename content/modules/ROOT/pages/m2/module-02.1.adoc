...
The Software Catalog is a centralised asset tracker for all of the softwares in your organization. It stores and tracks *Entities* reprensenting:
...
Feel free to explore it https://backstage.io/docs/features/software-catalog/references/ 
...
With that out of the way, let's get deploy your instance of {product_name_rhdh}!
