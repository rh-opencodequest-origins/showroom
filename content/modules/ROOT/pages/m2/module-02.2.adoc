...
Once you have chosen a user from team, go head !
...
. Visit the https://console-openshift-console.{openshift_cluster_ingress_domain}/topology/ns/rhdh-{team-id}?view=graph[backstage project^, window="console"] in your OpenShift cluster. You can login as *{pe-username}/{common_password}*
