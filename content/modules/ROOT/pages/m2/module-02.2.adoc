...
##This is a *Shared part*. It means, one person will be able to go through those steps. The work accomplished will be useful for everyone !##
...
Check if a user-pe can configure plaftform engineer
