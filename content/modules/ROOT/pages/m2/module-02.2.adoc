...
. Click the URL listed under the *Resources* tab; it will be similar to https://backstage-rhdh-team{team-id}.{openshift_cluster_ingress_domain}[https://backstage-rhdh-team{team-id}.{openshift_cluster_ingress_domain}^, window="rhdh"]
