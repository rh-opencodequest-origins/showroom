...
[NOTE] This is a *Shared part*. It means, one person will be able to go through those steps. The work accomplished will be useful for everyone !
...
. Visit the https://console-openshift-console.{openshift_cluster_ingress_domain}/topology/ns/rhdh-{team-id}?view=graph[backstage project^, window="console"] in your OpenShift cluster. You can login as *admin/{common_password}*
