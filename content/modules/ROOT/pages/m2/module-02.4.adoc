...
To explore how to represent and synchronize objects from external components in Developer Hub, we are going to add the Identity provider *Keycloak*.

Keycloak has users and groups already defined. We will use it to authenticate users into Developer Hub and import the associated groups. 
