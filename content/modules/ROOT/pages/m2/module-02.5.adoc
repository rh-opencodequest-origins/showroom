...
. Once the latest version of your `appConfig` has been synchronized and rolled out, visit your https://backstage-rhdh-team{team-id}.{openshift_cluster_ingress_domain}/[{product_name_rhdh} instance^, window="rhdh"]. You will be prompted to sign-in using OpenID Connect.
+
