...
```bash
wget https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/fullcodebase/-/blob/main/hero-service.zip?ref_type=heads -O hero-service.zip && unzip hero-service.zip && rm hero-service.zip
```
