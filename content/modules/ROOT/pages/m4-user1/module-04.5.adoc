...
```bash
wget https://github.com/rh-opencodequest-origins/fullcodebase/raw/refs/heads/main/hero-service.zip -O hero-service.zip && unzip hero-service.zip && rm hero-service.zip
```
