...
<div class="developer">
++++
Parts related to the developer role will start with a blue background color.
++++
</div>
++++
...
<div class="pe">
++++
Parts related to the platform engineer role will start with a red background color.
++++
</div>
++++
...
We need a template to create the essential resources to let developers start to contribute quickly :
...
The Software Template you'll be using in this activity is stored in the https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/opencodequest-templates/-/blob/main/scaffolder-templates/quarkus-postgresql/template.yaml?ref_type=heads[template.yaml, window="rhdh"]
