...
Check the content here : -> https://gitlab-gitlab.{openshift_cluster_ingress_domain}/peteam{team-id}/template-quarkus-simple/-/blob/main/template.yaml[template.yaml, window="gitlab"].
