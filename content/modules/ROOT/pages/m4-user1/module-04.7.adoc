...
image:m4/hero-swagger-ui-rhdh.png[]


#Then, select the `$USER-hero` provided API#
image:m4/openapi-provided-rhdh.png[]


#And, finally, click in the `Definition` tab# 

image:m4/hero-swagger-ui-rhdh-2.png[]
...
image:m4/swagger-ui.png[]

[NOTE]Ok, now, before continuing with the workshop...Please stop the hero-service launched in dev mode clicking `Ctrl + C` otherwise you will get a conflict port error.
