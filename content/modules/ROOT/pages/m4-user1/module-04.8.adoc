...
Now you have leveraged the magic internal developer portal by contributing / committing / deploying in your microservice, you will extend capabilies.

As you know, the GitOps flow is a part of the continous deployment but there is no view related to this flow. In a normal world, this view is more relevant to the Ops teams in charge to deploy. In the platform engineering philosophy, we want to unify the view related to objects created inside a development project.
