...
| Red Hat OpenShift Console|https://console-openshift-console.{openshift_cluster_ingress_domain}[Console^, window="console"] | *{dev-username}/{common_password}

| {product_name_rhdh} | https://backstage-rhdh-{team-id}.{openshift_cluster_ingress_domain}[click here^, window="rhdh"] | 
...
| GitOps/Argo (Platform setup) | https://openshift-gitops-server-openshift-gitops.{openshift_cluster_ingress_domain}[click here^, window="argo"] | admin/{common_password}
