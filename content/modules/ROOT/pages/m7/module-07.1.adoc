...
image:m7/pittfals-wrong-platform.png[Pitfalls of wrong platform approach showing multiple needs and fragmentation,link=self,window=blank] 
...
image:m7/platform-drift.png[Platform drift and platform sprawl diagram,link=self,window=blank] 
...
image:m7/evolving-platform.png[Continuously evolving platform with golden paths,link=self,window=blank] 
