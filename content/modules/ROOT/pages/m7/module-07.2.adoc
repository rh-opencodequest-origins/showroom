...
NOTE: The Adoption Insights plugin is currently in Developer Preview. Refer to the https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.5/html-single/adoption_insights_in_red_hat_developer_hub/index[Adoption Insights documentation^, window="docs"] for more information related to support.
