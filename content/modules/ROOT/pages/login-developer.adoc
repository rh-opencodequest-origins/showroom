...
+
image::common/rhdh-sign-out.png[Signing out of {product_name_rhdh} via Logout link,link=self,window=blank]
...
+
image::common/gitlab-sign-out.png[Signing out of GitLab from Profile dropdown,link=self,window=blank]
