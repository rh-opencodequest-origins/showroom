...
<div class="pe">
++++
Parts related to the platform engineer role will be highlighted with a red background color.
++++
</div>
++++
...
The Software Template you'll be using in this activity is stored in the https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/quarkus-ai[template.yaml, window="gitlab"] file repository in GitLab.
...
----
https://gitlab-gitlab.{openshift_cluster_ingress_domain}/pe{team-id}/opencodequest-templates/-/blob/main/scaffolder-templates/quarkus-ai/template.yaml?ref_type=heads
----
