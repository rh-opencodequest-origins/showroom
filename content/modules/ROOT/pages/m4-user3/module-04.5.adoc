...
```bash
wget https://github.com/rh-opencodequest-origins/fullcodebase/raw/refs/heads/main/fight-service.zip -O fight-service.zip && unzip fight-service.zip && rm fight-service.zip
```
