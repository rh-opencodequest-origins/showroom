...
NOTE: The UI dashboard will be updated once the commit done. To simplify the developement flow, we'll commit later with the changes done on our code base
