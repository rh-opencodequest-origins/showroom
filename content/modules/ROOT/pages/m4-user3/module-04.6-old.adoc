...
HELPER GIT quand dev profil is not PE in gitlab 
...
From there, you can access your fight microservice by clicking on the pod.

== Exploring the pipeline

Let's switch to the Developer Hub console, in your fight component.
...
As you can see, it looks like a **bad dependency** has been introduced in our code! 
...
== Deploy the Fight microservice after fixing the issue
...
//How to test the flight service with the terminal?  
...
#Promotion to preprod and prod should be done for every service fight#
